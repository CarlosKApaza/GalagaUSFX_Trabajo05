...
#include "GalagaUSFX_Trabajo04/Publisher.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GALAGAUSFX_TRABAJO04_API UClass* Z_Construct_UClass_APublisher_NoRegister();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_APublisher_Statics::NewProp_Subscribers = { "Subscribers", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APublisher, Subscribers), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_APublisher_Statics::NewProp_Subscribers_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APublisher_Statics::NewProp_Subscribers_MetaData)) };
	...
	IMPLEMENT_CLASS(APublisher, 2568028804);
	template<> GALAGAUSFX_TRABAJO04_API UClass* StaticClass<APublisher>()
	{
		return APublisher::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APublisher(Z_Construct_UClass_APublisher, &APublisher::StaticClass, TEXT("/Script/GalagaUSFX_Trabajo04"), TEXT("APublisher"), false, nullptr, nullptr, nullptr);
